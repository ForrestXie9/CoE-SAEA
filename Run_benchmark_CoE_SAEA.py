...
if __name__ == "__main__":
    ...
    paras = Paras()
    # Set parameters #
    paras.set_paras(llm_api_endpoint="api.bltcy.ai",  #add your api_endpoint
                    llm_api_key="sk-HP9q0KbAtHa1r3dK7fA1EbCf887b44BfB1E3074dB1Ed34Ea", #add your key
                    llm_model="gpt-4o-mini",  #choose llm model
